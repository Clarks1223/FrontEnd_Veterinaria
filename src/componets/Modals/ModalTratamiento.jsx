...
const ModalTratamiento = ({ idPaciente }) => {
  const { setModal, handleModal, registrarTratamientos, mensajeElimn } =
      ...
      <form className="p-10" onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <select
            ...
            className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md mb-5"
            name="prioridad"
            value={form.prioridad} //vincula el valor del estado
            onChange={handleChange} //usa la funcion de manejo de cambio
          >
